...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Buttons_Fire = m_Buttons.FindAction("Fire", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Buttons_Fire;
    public struct ButtonsActions
    {
        private @InputActions m_Wrapper;
        public ButtonsActions(@InputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Fire => m_Wrapper.m_Buttons_Fire;
